      ...
      <section id="home" class="tab-pane fade in active">
        <article class="home-content">
          <header role="home-title">
            <h2>This is
              <div id="typed-strings"><span>Vehicles</span> <span></span> <span>Making item</span> <span>Success Story</span>
...
<script src="js/countdown-js-item.js" type="text/javascript"></script>
