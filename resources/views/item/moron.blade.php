...
<body style="background-image: url(images/lean-bg/lean-revenue.jpg);">
...
<header role="main-header">
  <div class="container">
    ...
    <h1> <a href="index.html" title="opening" style="color:#fed136; text-decoration:none">Templet</h1>
      ...
      <section id="home" class="tab-pane fade in active">
        <article class="home-content">
          <header role="home-title">
            <h2>This is
              <div id="typed-strings"><span>MORON</span> <span></span> <span>Making item</span> <span>Success Story</span>
              <span>Great achiever</span>
               </div>
...
<script src="js/countdown-js-lean-uni.js" type="text/javascript"></script>
