...
<body style="background-image: url(images/lean-bg/lean-cost.jpg);">
      ...
      <section id="home" class="tab-pane fade in active">
        <article class="home-content">
          <header role="home-title">
            <h2>This is
              <div id="typed-strings"><span>Cost Structure</span> <span>Leancanvas</span> <span>Your business</span> <span>Starting here</span> </div>
...
<script src="js/countdown-js-lean-cost.js" type="text/javascript"></script>
