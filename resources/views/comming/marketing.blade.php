      ...
      <section id="home" class="tab-pane fade in active">
        <article class="home-content">
          <header role="home-title">
            <h2>This is
              <div id="typed-strings"><span>Your Business</span> <span>Marketing</span> <span>Starting here</span>
...
<script src="js/countdown-js-bs-marketing.js" type="text/javascript"></script>
<script type="text/javascript" src="js/jquery-lean.contact.js"></script>h
