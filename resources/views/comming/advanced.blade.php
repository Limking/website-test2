      ...
      <section id="home" class="tab-pane fade in active">
        <article class="home-content">
          <header role="home-title">
            <h2>This is
              <div id="typed-strings"><span>Your Business</span> <span>Advanced</span> <span>Starting here</span>
...
<script src="js/countdown-js-bs-advanced.js" type="text/javascript"></script>
